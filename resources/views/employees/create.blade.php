@extends('layouts.app', [
  ...
  'titlePage' => __('Employee Management')
])
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group{{ $errors->has('admission_date') ? ' has-danger' : '' }}">
                      <input type="text" class="form-control{{ $errors->has('admission_date') ? ' is-invalid' : '' }} datetimepicker" value="{{ now()->format('d-m-Y') }}" required/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group{{ $errors->has('office') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('office') ? ' is-invalid' : '' }}" name="office" id="input-office" type="office" placeholder="{{ __('Office') }}" value="{{ old('office') }}" />
                  ...
                  <div class="col-sm-2">
                    <div class="form-group{{ $errors->has('salary') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('salary') ? ' is-invalid' : '' }}" name="salary" id="input-salary" type="text" placeholder="{{ __('Salary') }}" value="{{ old('salary') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-2">
                    <div class="form-group{{ $errors->has('birthdate') ? ' has-danger' : '' }}">
                      <input type="text" class="form-control{{ $errors->has('birthdate') ? ' is-invalid' : '' }} datetimepicker" placeholder="{{ __('Birthdate') }}" />
