@extends('layouts.app', [
  'activePage' => 'installation-management',
  'menuParent' => 'management',
  'titlePage' => __('Installation Management')
])
...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" enctype="multipart/form-data" action="{{ route('installation.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            ...
            <div class="card ">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Add Installation') }}</h4>
              </div>
              <div class="card-body ">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <select class="col-sm-7 form-control selectpicker" data-style="btn btn-link" id="personSelect">
                    <option value="1">{{ __('Plan 1') }}</option>
                    <option value="2">{{ __('Plan 2') }}</option>
                  </select>
                </div>
                <div class="row">
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-rose">{{ __('Add Installation') }}</button>
              </div>
            </div>
          </form>
        </div>
