...
@section('content')
  <div class="content">
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-12">
          <form method="post" enctype="multipart/form-data" action="{{ route('internetPlan.store') }}" autocomplete="off" class="form-horizontal">
            @csrf
            @method('post')
            ...
            <div class="card ">
              <div class="card-header card-header-rose card-header-icon">
                ...
                <h4 class="card-title">{{ __('Add Internet Plan') }}</h4>
              </div>
              <div class="card-body ">
                <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('velocity-download') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('velocity-download') ? ' is-invalid' : '' }}" name="velocity-download" id="input-velocity-download" type="velocity-download" placeholder="{{ __('Vel. Download') }}" value="{{ old('velocity-download') }}" required />
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('velocity-upload') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('velocity-upload') ? ' is-invalid' : '' }}" name="velocity-upload" id="input-velocity-upload" type="velocity-upload" placeholder="{{ __('Vel. Upload') }}" value="{{ old('velocity-upload') }}" required />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('quantity-tolerance-days') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('quantity-tolerance-days') ? ' is-invalid' : '' }}" name="quantity-tolerance-days" id="input-quantity-tolerance-days" type="quantity-tolerance-days" placeholder="{{ __('Qtd. of tolerance days') }}" value="{{ old('quantity-tolerance-days') }}" />
                  ...
                  <div class="col-sm-2">
                    <div class="form-group{{ $errors->has('advance-payment-discount') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('advance-payment-discount') ? ' is-invalid' : '' }}" name="advance-payment-discount" id="input-advance-payment-discount" type="text" placeholder="{{ __('Advance Pay. Discount') }}" value="{{ old('advance-payment-discount') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group{{ $errors->has('mensal-value') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('mensal-value') ? ' is-invalid' : '' }}" name="mensal-value" id="input-mensal-value" type="mensal-value" placeholder="{{ __('Mensal Value') }}" value="{{ old('mensal-value') }}" required />
                  ...
                  <div class="col-sm-2">
                    <div class="form-group{{ $errors->has('installation-fee') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('installation-fee') ? ' is-invalid' : '' }}" name="installation-fee" id="input-installation-fee" type="text" placeholder="{{ __('Installation Fee') }}" value="{{ old('installation-fee') }}" />
                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('tech-used') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('tech-used') ? ' is-invalid' : '' }}" name="tech-used" id="input-tech-used" type="tech-used" placeholder="{{ __('Technology Used') }}" value="{{ old('tech-used') }}" />
              ...
              <div class="card-footer ml-auto mr-auto">
                <button type="submit" class="btn btn-rose">{{ __('Add Internet Plan') }}</button>
              </div>
            </div>
          </form>
        </div>
